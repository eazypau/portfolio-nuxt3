  ...
  const timeline = [
    {
      ...
      jobScope: [
        "Delivered 150+ production-ready features for a cloud-based Electronic Health Record (EHR) platform using React, TypeScript, Redux, and Material UI, expanding platform capabilities and enhancing clinical workflows",
        "Led technical feasibility studies and proof-of-concepts (PoCs) for new product capabilities, evaluating architectural approaches and reducing implementation risks before development",
        "Facilitated sprint planning and effort estimation by leveraging historical delivery metrics, improving planning accuracy and enabling predictable sprint outcomes",
        "Reviewed pull requests to uphold engineering standards, improve maintainability, optimize performance, and promote knowledge sharing across the team",
        "Built reusable and maintainable UI components, reducing duplicated implementation and improving development consistency across multiple modules",
        "Designed and implemented interactive laboratory dashboards using Chart.js, enabling clinicians to visualize patient laboratory trends and make faster, data-driven decisions",
        "Developed and enhanced inventory management workflows, improving medical supply tracking, reporting accuracy, and operational efficiency",
        "Resolved 50+ critical production issues, performing root-cause analysis and delivering reliable fixes to maintain high system availability and minimize downtime",
        "Coordinated release activities across development and production environments, ensuring smooth deployments with minimal disruption to users",
        "Partnered with Product Owners, QA engineers, designers, and business stakeholders to translate complex business requirements into scalable technical solutions",
        "Leveraged AI-assisted development tools to accelerate implementation, reduce repetitive work, and improve engineering productivity while maintaining high code quality",
        "Authored technical documentation and implementation guides to improve onboarding, knowledge sharing, and long-term maintainability",
      ],
    },
    {
    ...
    },
    {
      ...
      jobScope: [
        "Developed and maintained Shopify e-commerce storefronts by implementing custom features using JavaScript, jQuery, HTML, CSS, and Shopify Liquid",
        "Collaborated closely with designers and QA engineers to redesign the FlowerChimp shopping cart experience, simplifying the checkout journey and improving overall user experience",
        "Revamped the FlowerChimp homepage and product pages to improve customer engagement, visual consistency, and product discoverability",
        "Migrated legacy Shopify themes from Online Store 1.0 to Online Store 2.0, modernising storefront architecture and improving long-term maintainability",
        "Optimised frontend performance using browser performance profiling, reducing Cumulative Layout Shift (CLS) from 0.19 to 0.025, improving Core Web Vitals and Lighthouse performance scores",
        "Improved website loading performance through code splitting, lazy loading, deferred scripts, and asset optimisation",
      ],
    },
    {
      ...
      jobScope: [
        ...
        "Collaborated with backend developers and designers to deliver responsive, accessible, and cross-browser compatible web applications",
        "Built landing pages and marketing websites using modern frontend technologies while maintaining responsive design best practices using Nuxt3 and TailwindCSS",
      ],
    },
    {
      ...
      jobScope: [
        "Prepared engineering proposals, cost estimations, and feasibility studies to support client decision-making during project planning",
        "Produced technical documentation, design specifications, tender documents, and evaluation reports, assessing contractor pricing, technical compliance, and project capabilities",
        "Designed fire protection systems for semiconductor manufacturing facilities and commercial buildings in compliance with Malaysia Standards (MS), NFPA, and FM requirements, ensuring regulatory approval and insurance compliance",
        "Coordinated with architects, surveyors, contractors, and multidisciplinary engineering teams to streamline design reviews, resolve technical issues, and ensure successful project delivery.",
      ],
    },
  ];
