<template>
  ...
  >
    <div
      :class="[
        isReverse ? 'right-0 border-l' : 'left-0',
        'md:absolute md:w-8/12 md:h-full',
      ]"
    >
      <!-- img -->
    ...
    <div
      :class="[
        isReverse ? 'md:float-left' : 'md:float-right',
        'px-6 py-4 flex flex-col justify-between min-h-56 md:h-96 md:w-4/12 subFontFamily',
      ]"
    >
      <!-- content -->
      <div>
