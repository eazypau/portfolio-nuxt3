<template>
  <a
    :href="details.route"
    class="group h-96 flex flex-col bg-gray-100 rounded-lg shadow-lg overflow-hidden relative"
  >
    <img
      :src="details.imgUrl"
      loading="lazy"
    ...
    <div class="relative p-4 mt-auto">
      <span class="block text-gray-200 text-sm">{{ details.date }}</span>
...
export default {
  ...
  setup(props) {
    ...
    const goToBlogPost = () => {
      router.push(props.details.route);
    };
    return { goToBlogPost };
  },
};
