    ...
    <div class="container px-6 py-8 mx-auto">
      <div class="items-center lg:flex lg:space-x-6">
        <div class="lg:w-1/2 2xl:w-9/12 subFontFamily">
          ...
          <p class="mt-4 text-gray-500 lg:max-w-md 2xl:max-w-lg 3xl:max-w-xl text-justify lg:text-lg 2xl:text-2xl">
          ...
          <div class="flex items-center mt-6 -mx-2">
            <a class="mx-2" href="https://www.instagram.com/yzpo/" aria-label="Instagram" target="blank">
              <!-- <svg class="IconInProfile" viewBox="0 0 24 24">
                <path
            ...
            <a class="mx-2" href="https://www.facebook.com/yizhipo" aria-label="Facebook" target="blank">
              <!-- <svg class="IconInProfile" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path
